const connect_to_db = require('./db_WatchNextByIdx'); //carico il DB, carica il file db.js

// GET BY TALK HANDLER

const talk = require('./Talks_WatchNextByIdx'); //carico il modello dati nel file Talk.js
...
module.exports.get_watch_next_by_idx = (event, context, callback) => {
    ...
    if(!body._id) {
        ...
        callback(null, {
                    ...
                    body: 'Could not fetch the _id. _id is null.'
        })
    }
